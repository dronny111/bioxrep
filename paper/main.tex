...
$\le 0.004$ on every metric); the deterministic lexical, SapBERT, and BioSyn
...
deviations, and its in-domain validation top-1 is likewise lower ($0.449 \pm 0.010$
vs.\ $0.598 \pm 0.005$). Self-attention over raw bytes is thus no better---and here
